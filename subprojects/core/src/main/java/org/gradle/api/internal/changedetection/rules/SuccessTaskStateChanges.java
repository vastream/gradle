...
public class SuccessTaskStateChanges implements TaskStateChanges {
    ...
    public SuccessTaskStateChanges(@Nullable TaskExecution previousExecution, TaskExecution currentExecution, TaskInternal task) {
